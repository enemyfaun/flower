...
window.addEventListener("load", () => {
     setTimeout(() => {
          document.getElementsByTagName("body")[0].classList.add("rotateAfter");
          document
               .getElementsByTagName("body")[0]
               .classList.add("rotateBefore");
          document.getElementsByTagName("html")[0].classList.add("rotateAfter");
     }, 1500);
});
